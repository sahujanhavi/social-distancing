...
import os
# print()
for dirname, _, filenames in os.walk('social-distancing-input'):
...
input_data = 'social-distancing-input/pedestrians.mp4'
output_data = 'output/output.avi'
display = 0
...
# play video on kaggle
# from IPython.display import HTML
# from base64 import b64encode
# vid1 = open('output/output.avi','rb').read()
